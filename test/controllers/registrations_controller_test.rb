...
class RegistrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registration" do
    assert_difference('Registration.count') do
      post registrations_url, params: { registration: { address: @registration.address, code: @registration.code, name: @registration.name } }
    end
  ...
  test "should update registration" do
    patch registration_url(@registration), params: { registration: { address: @registration.address, code: @registration.code, name: @registration.name } }
